# --- NAMA TABEL DATABASE ---
TABLE_NAME_5G = "region_balinusra.ran_cell_5g_day_balinusra_live"

# --- DEFINISI KOLOM 5G ---
MANDATORY_COLUMNS_5G = ['date', 'site_id', 'site_name', 'enodeb_id', 'enodeb_name']
...
# --- DAFTAR KPI UNTUK 5G DAILY (SIMPLE MODE) ---
SIMPLE_KPI_MAP_5G = {
    "Accessibility": [
...
# --- DAFTAR KPI LENGKAP UNTUK 5G DAILY (ADVANCED MODE) ---
ADVANCED_KPI_MAP_5G = {
    "Raw Accessibility": [
        ("nr_sn_setup_success_rate", "NR SN Setup SR (%)", "AVG"),
