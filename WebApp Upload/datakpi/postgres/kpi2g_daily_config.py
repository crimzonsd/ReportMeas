# --- NAMA TABEL DATABASE ---
TABLE_NAME_2G = "region_balinusra.ran_cell_2g_day_balinusra_live"

# --- DEFINISI KOLOM ---
MANDATORY_COLUMNS_2G = ['date', 'site_id', 'site_name', 'bsc_name', 'ci']
CELL_SPECIFIC_MANDATORY_COLUMNS_2G = ['cell_name', 'ci']
OPTIONAL_COLUMNS_2G = [
    'vendor', 'cell_name', 'lac', 'ne_id', 'region', 'sales_region', 'cgipre', 'cgipost', 'band', 'type', 'bts_type', 'sector', 
...
# --- DAFTAR KPI UNTUK 2G DAILY (SIMPLE MODE) ---
SIMPLE_KPI_MAP_2G = {
    "Accessibility": [
...
# --- DAFTAR KPI LENGKAP UNTUK 2G DAILY (ADVANCED MODE) ---
ADVANCED_KPI_MAP_2G = {
