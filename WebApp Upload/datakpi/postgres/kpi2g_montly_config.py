...
TABLE_NAME_2G = "region_balinusra.ran_cell_2g_month_balinusra_live"

# --- DEFINISI KOLOM ---
# Struktur disamakan dengan daily, namun 'date'/'week' diganti 'month'
MANDATORY_COLUMNS_2G_SITE = ['month', 'site_id', 'site_name', 'bsc_name']
CELL_SPECIFIC_MANDATORY_COLUMNS_2G = ['ci','cell_name']
...
# --- DAFTAR KPI UNTUK 2G MONTHLY (SIMPLE MODE - DISAMAKAN DENGAN DAILY) ---
SIMPLE_KPI_MAP_2G = {
    "Accessibility": [
...
# --- DAFTAR KPI LENGKAP UNTUK 2G MONTHLY (ADVANCED MODE - DISAMAKAN DENGAN DAILY) ---
ADVANCED_KPI_MAP_2G = {
