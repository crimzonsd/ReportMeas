# --- NAMA TABEL DATABASE ---
TABLE_NAME_4G = "region_balinusra.ran_cell_4g_hour_balinusra"

# --- DEFINISI KOLOM ---
MANDATORY_COLUMNS_4G = ['datetime', 'hour', 'site_id', 'site_name', 'enodeb_id', 'enodeb_name']
CELL_SPECIFIC_MANDATORY_COLUMNS_4G = ['cell_name', 'ci']
OPTIONAL_COLUMNS_4G = [
    'dayofyear', 'date', 'vendor', 'tac', 'ne_id', 'region', 'sales_region', 'band', 'type', 'sector', 
    'sector_id', 'site_sign', 'bts_sign', 'cell_sign', 'site', 'bts', 'bts_sign_nqm', 'bts_nqm', 'longitude_fix', 
    'latitude_fix', 'longlat_fix_source', 'azimuth', 'horizontal_beamwidth', 'vertical_beamwidth', 'mc_class', 
    'cluster_name', 'sub_name', 'branch_name', 'id_desa', 'desa', 'id_kecamatan', 'kecamatan', 'id_kabupaten', 
    'kabupaten', 'province', 'priority_city', 'trueconex_scope', 'poi_name', 'poi_type_l1', 'poi_key', 'poi_flag', 
    'gogreen_category', 'bandwidth', 'week', 'poi_bbc_class', 'bbc_grouping_cities', 'bbc_class', 'trueconex_class', 
    'area', 'ip_source', 'departement', 'technical_area', 'tower_provider_name', 'bandtype', 'frequency', 'poi_2020', 
    'poi_2020_type', 'flexible_bandwidth', 'region_new'
]
...
SIMPLE_KPI_MAP_4G = {
    ...
    "Integrity": [
        ("cell_downlink_throughput", "Cell DL Avg Throughput (Mbps)", "AVG"),
        ("cell_uplink_throughput", "Cell UL Avg Throughput (Mbps)", "AVG"),
        ("user_downlink_throughput", "User DL Avg Throughput (Mbps)", "AVG"),
        ("user_uplink_throughput", "User UL Avg Throughput (Mbps)", "AVG")
    ],
    "Availability": [
...
ADVANCED_KPI_MAP_4G = {
    ...
    "Raw Traffic": [
        ...
        ("max_dl_traffic_volume_mbyte", "Max DL Payload (MB)", "MAX"),
        ("min_dl_traffic_volume_mbyte", "Min DL Payload (MB)", "MIN"),
        ("max_ul_traffic_volume_mbyte", "Max UL Payload (MB)", "MAX"),
        ("min_ul_traffic_volume_mbyte", "Min UL Payload (MB)", "MIN"),
    ...
    "Raw Users": [
        ...
        ("dl_active_user_avg", "DL Active User Avg", "AVG"),
        ("dl_active_user_max", "DL Active User Max", "MAX"),
        ("ul_active_user_avg", "UL Active User Avg", "AVG"),
        ("ul_active_user_max", "UL Active User Max", "MAX"),
    ],
    "Raw Throughput": [
    ...
    "Raw PRB": [
        ...
        ("avg_prb_usage_dl", "Avg PRB Usage DL", "AVG"),
    ...
    "Raw CSFB & Paging": [
        ...
        ("no_redirection_requests_lte_utran_csfb", "No. Redir Req LTE-UTRAN CSFB", "AVG"),
        ("no_redirection_requests_lte_gsm_csfb", "No. Redir Req LTE-GSM CSFB", "AVG"),
        ("paging_number_from_s1", "Paging from S1", "AVG"),
    ],
    "Raw VoLTE & SRVCC": [
    ...
    "Raw Quality (CQI, VQI, MOS)": [
        ("average_cqi_rate", "Average CQI", "AVG"),
        ("average_cqi_num", "Num Average CQI", "SUM"),
        ("average_cqi_denum", "Denum Average CQI", "SUM"),
        ("good_cqi_rate", "Good CQI Rate (%)", "AVG"),
        ("good_cqi_num", "Num Good CQI", "SUM"),
        ("good_cqi_denum", "Denum Good CQI", "SUM"),
