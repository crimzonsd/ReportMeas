# --- NAMA TABEL DATABASE ---
# Catatan: Nama tabel ini diasumsikan mengikuti pola yang ada. Silakan sesuaikan jika berbeda.
TABLE_NAME_5G = "region_balinusra.ran_cell_5g_month_balinusra_live"

# --- DEFINISI KOLOM 5G ---
# Struktur disamakan dengan daily/weekly, namun 'date'/'week' diganti 'month'
MANDATORY_COLUMNS_5G_SITE = ['month', 'site_id', 'site_name', 'enodeb_id', 'enodeb_name']
...
# --- DAFTAR KPI UNTUK 5G MONTHLY (SIMPLE MODE - DISAMAKAN DENGAN DAILY/WEEKLY) ---
SIMPLE_KPI_MAP_5G = {
    "Accessibility": [
...
# --- DAFTAR KPI LENGKAP UNTUK 5G MONTHLY (ADVANCED MODE - DISAMAKAN DENGAN DAILY/WEEKLY) ---
ADVANCED_KPI_MAP_5G = {
    "Raw Accessibility": [
        ("nr_sn_setup_success_rate", "NR SN Setup SR (%)", "AVG"),
