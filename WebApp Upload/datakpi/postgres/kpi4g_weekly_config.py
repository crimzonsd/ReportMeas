# --- NAMA TABEL DATABASE ---
TABLE_NAME_4G = "region_balinusra.ran_cell_4g_week_balinusra"

# --- DEFINISI KOLOM ---
# Struktur disamakan dengan daily, namun 'date' diganti 'week'
# Kolom dasar yang selalu digunakan (basisnya adalah Site Level)
MANDATORY_COLUMNS_4G_SITE = ['week', 'site_id', 'site_name', 'enodeb_id', 'enodeb_name']
...
# --- DAFTAR KPI UNTUK 4G WEEKLY (SIMPLE MODE - DISAMAKAN DENGAN DAILY) ---
SIMPLE_KPI_MAP_4G = {
    "Accessibility": [
...
# --- DAFTAR KPI LENGKAP UNTUK 4G WEEKLY (ADVANCED MODE - DISAMAKAN DENGAN DAILY) ---
ADVANCED_KPI_MAP_4G = {
    "Raw Accessibility": [
