# --- NAMA TABEL DATABASE ---
TABLE_NAME_4G = "region_balinusra.ran_cell_4g_day_balinusra_live"

# --- DEFINISI KOLOM ---
MANDATORY_COLUMNS_4G = ['date', 'site_id', 'site_name', 'enodeb_id', 'enodeb_name']
...
OPTIONAL_COLUMNS_4G = [
    ...
    'poi_type_l1', 'poi_key', 'poi_flag', 'gogreen_category', 'bandwidth', 'week', 'poi_bbc_class', 'bbc_grouping_cities', 
...
# --- DAFTAR KPI UNTUK 4G DAILY (SIMPLE MODE) ---
SIMPLE_KPI_MAP_4G = {
    "Accessibility": [
...
# --- DAFTAR KPI LENGKAP UNTUK 4G DAILY (ADVANCED MODE) ---
ADVANCED_KPI_MAP_4G = {
    "Raw Accessibility": [
